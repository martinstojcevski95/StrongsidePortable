...
namespace GameCreator.Characters
{
    ...
    public class CharacterLocomotion
    {
        ...
        public void SetNavMeshTarget(Vector3[] positions, ILocomotionSystem.TargetRotation rotation,
            float stopThreshold, UnityAction callback = null)
        {
            this.ChangeLocomotionSystem<LocomotionSystemTarget>();
            ((LocomotionSystemTarget)this.currentLocomotionSystem)
                .SetNavMeshTarget(positions, rotation, stopThreshold, callback);
        }

        public void SetAStarTarget(Path path, ILocomotionSystem.TargetRotation rotation,
            float stopThreshold, UnityAction callback = null)
        {
            this.ChangeLocomotionSystem<LocomotionSystemAStar>();
            ((LocomotionSystemAStar)this.currentLocomotionSystem)
                .SetTarget(path, rotation, stopThreshold, callback);
        }

        public void SetAStarTarget(Vector3 position, ILocomotionSystem.TargetRotation rotation,
            float stopThreshold, UnityAction callback = null)
        {
            this.ChangeLocomotionSystem<LocomotionSystemAStar>();
            ((LocomotionSystemAStar)this.currentLocomotionSystem)
        ...
        {
            this.ChangeLocomotionSystem<LocomotionSystemTarget>();
            ((LocomotionSystemTarget)this.currentLocomotionSystem).Stop(callback);
        }
